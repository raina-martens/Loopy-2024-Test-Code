...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // autodrive
    JoystickButton driverAButton = new JoystickButton(driverJoystick, 0);
    JoystickButton driverBButton = new JoystickButton(driverJoystick, 1);

    JoystickButton driverYButton = new JoystickButton(driverJoystick, 4);
    ...
    //driving
    Command driveCommand = new Drive(driveSubsystem,
